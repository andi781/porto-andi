      ...
      <div class="container">
        <div class="row no-gutters slider-text js-fullheight align-items-center justify-content-start" data-scrollax-parent="true">
          <div class="col-md-9 ftco-animate" data-scrollax=" properties: { translateY: '70%' }">
            <h1 class="mb-4" data-scrollax="properties: { translateY: '30%', opacity: 1.6 }"><strong>Hello <br></strong> Andi Bagus Cahyono</h1>
            <p data-scrollax="properties: { translateY: '30%', opacity: 1.6 }">Computer and Network Engineering</p>
            <div>
